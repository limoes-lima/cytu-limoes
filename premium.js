...
# See About stuff on the original file
# Version:		2.12.2
...
FaviconURL		= 'https://b.catgirlsare.sexy/CwY0-IicHW-k.png';
ChannelName		= '://OpenSockettGirl';
MiniLogoURL		= 'https://b.catgirlsare.sexy/CwY0-IicHW-k.png';
CustomWelcomeText	= 'Olá';
WelcomeSoundFileURL	= '';
MOTDAlteredElement	= '';
MOTDAlteredHTML		= '';
AnnouncementHTML	= '';
JoinMessage		= 'conectou';
LeaveMessage		= 'saiu';
NowPlaying		= 'Tocando:';
PlayingNext		= 'Próxima';
PlayerCoveringURL	= '';
...
AnswersArray		= [
	'Pra caralho!', 'Sim', 'Talvez sim', '50%', 'Talvez não',
	'Não!', 'Definitivamente não!', 'Pergunte outra vez', 'Não vou responder agora'
];

FortunesArray		= [
	'Grande benção, jogue no bicho hoje mesmo', 'Grande maldição, não saia de casa hoje', 'Seu maior desejo se tornará realidade', 'Seu maior desejo NÃO se tornará realidade', 'Você vai encontrar com a pessoa que você gosta',
	'Você vai perder alguém que você gosta', 'Você vai achar algo que perdeu', 'Você vai perder alguma coisa',
	'Você vai achar dinheiro', 'Você vai perder dinheiro', 'Sorte nos estudos', 'Azar nos estudos', 'Você vai brigar com alguém',
	'Vai arrumar uma namoradinha', 'Doença grave', 'Você terá um dia simples e normal',
	'Não estou a fim de ler sua fortuna agora', 'Você será isekaisado',
];

SoundFiltersArray	= {'!habemus': 'https://dl.dropboxusercontent.com/s/3w1jahgffowjltz/hp.ogg',
'!nyaa': 'https://dl.dropboxusercontent.com/s/gzsxqypc6qa7del/nyaa.ogg',
'!vaicomprarpao': 'https://dl.dropboxusercontent.com/s/7uu6vmijf7dtqvc/VAICOMPRARPAOFDP.ogg',
'!AAAAAAAAAAAAAAA': 'https://dl.dropboxusercontent.com/s/n6i8bb889nmyaxl/AAAAAAAAAAAAAAA.ogg',
'!aiaiaiiii': 'https://dl.dropboxusercontent.com/s/7s7n0xdxk17qtxy/aiaiaiiii.ogg',
'!aimamae': 'https://dl.dropboxusercontent.com/s/h5l13vemwz6n4f2/aimamae.ogg',
'!alert': 'https://dl.dropboxusercontent.com/s/kqt2rcu8uljufhe/alert.ogg',
'!aopotencia': 'https://dl.dropboxusercontent.com/s/wd4ni5tqejv3agr/aopotencia.ogg',
'!aquacry': 'https://dl.dropboxusercontent.com/s/72224a0pa2amaml/aquacry.ogg',
'!aquarindo': 'https://dl.dropboxusercontent.com/s/p8npfwtirmb6h79/aquarindo.ogg',
'!arara': 'https://dl.dropboxusercontent.com/s/zqd90o3u007p5a0/araara.ogg',
'!arigatou': 'https://dl.dropboxusercontent.com/s/t2z0gwx54ye2yov/arigatou.ogg',
'!ata': 'https://dl.dropboxusercontent.com/s/v1f0szcmgd88489/ata.ogg',
'!atumalaca': 'https://dl.dropboxusercontent.com/s/g1jj22032o7oda6/atumalaca.ogg',
'!ayylmao': 'https://dl.dropboxusercontent.com/s/6s8nwltwysxvdyy/ayylmao.ogg',
'!bang': 'https://dl.dropboxusercontent.com/s/0ecfi5pylckct8z/bang.ogg',
'text_or_code': 'sound_file_URL',};

FactsArray		= [ 'é bundeiro.', 'é informante do STF.', 'peidou na alimentação do réu.', 'vai sair com um travesti esse fim de semana.', 'larpa de menininha no salmão.', 'é um zoomer de bosta.', 'tomou leite de macho e pediu mais.', 'é um verdadeiro chad.', 'é um beta.', 'já fez coisinhas com a priminha.', ];

ImgurClientID		= 'a11c2b9fbdd104a';

GiphyAPIKey		= 'Y0piSv4MR3WX56ebW0brxWKocOMICgaK';
...
SHOWCONTRIBS	= getOrDefault('SP_showcontribs',	true);
SHOWIMAGES	= getOrDefault('SP_showimages',		true);
SHOWMASCOT	= getOrDefault('SP_showmascot',		false);
SHOWOEKAKI	= getOrDefault('SP_showoekaki',		false);
SHOWVIDEOS	= getOrDefault('SP_showvideos',		true);
...
CATGIRLS		= 'https://b.catgirlsare.sexy/';
...
// Wallpapers List
WallpapersArray = [
      "https://b.catgirlsare.sexy/gvklj-HhnrU4.jpg", // default
      "https://b.catgirlsare.sexy/Ikx5h8yNKLvS.jpg", // dark purple bg
      "#0F0F0F", // cinza escuro
];

  window.onload = () => {
    const randomIndex = Math.floor(Math.random() * WallpapersArray.length);
    const selectedImage = WallpapersArray[randomIndex];
...
function theatreMode() {
	...
	closebtn = $('<button id="close-btn" class="btn btn-outline-dark pointer" title="Close Theatre Mode" />')
	  .addClass(!SYNCH ? 'tmode' : 'tmode2').appendTo("body")
	  .append('<span class="glyphicon glyphicon-new-window" />')
	  .on("click", function() {
		closeTheatreMode();
	  });
	switchbtn = $('<button id="switch-btn" class="btn btn-outline-dark pointer" title="Switch to Radio Mode" />')
	  .addClass(!SYNCH ? 'tmode' : 'tmode2').appendTo("body")
...
function radioMode() {
	...
	closebtn = $('<button id="close-btn" class="btn btn-outline-dark pointer tmode" title="Close Radio Mode" />')
	  .appendTo("body").append('<span class="glyphicon glyphicon-new-window" />')
	  .on("click", function() {
		closeRadioMode();
	  });
	switchbtn = $('<button id="switch-btn" class="btn btn-outline-dark pointer tmode" title="Switch to Theatre Mode" />')
	  .appendTo("body").append('<span class="glyphicon glyphicon-th-list" />')
	  .on("click", function() {
		closeRadioMode();
		theatreMode();
	  });
	cssbtn = $('<button id="css-btn" class="btn btn-outline-dark pointer" title="Theme & User CSS" />')
...
function playerMascot(mode) {
	if (mode == "hide") {
		...
		var arr = [
			['Guu Swipe', CATGIRLS + '5xKy2ezn9Wf4.gif'],
...
var html = '<div class="well"><div class="btn-group">'
	 ...
	 +   '<button id="changebg-btn" class="btn btn-sm btn-default" title="Change Background">Change BG</button>'
...
var html = '<br />Powered by: <b>OwO</b> v. ' + VERSION + ', Custom JS by © 2016-2019 ZimnyLech · '
...
//test
$("#changebg-btn").on("click", function() {
  if (confirm('Click OK to change Background Wallpaper')) {
    if (WallpapersArray.length > 0) {
      const randomIndex = Math.floor(Math.random() * WallpapersArray.length);
      const selectedImage = WallpapersArray[randomIndex];
      document.body.style.backgroundImage = `url('${selectedImage}')`;
    } else {
      alert("No wallpapers available.");
    }
  }
});
